...
//IMPLEMENT_SHADER_TYPE(, FLensDistortionUVGenerationVS, TEXT("/Plugins/GloadShader/Shaders/Private/MyShader.usf"), TEXT("MainVS"), SF_Vertex)
//IMPLEMENT_SHADER_TYPE(, FLensDistortionUVGenerationPS, TEXT("/Plugins/GloadShader/Shaders/Private/MyShader.usf"), TEXT("MainPS"), SF_Pixel)
